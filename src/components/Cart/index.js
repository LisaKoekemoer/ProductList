    ...
    <div className={styles.cartContainer}>
        ...
        {!totalCartItemsCount ? (
            <div className={styles.emptyCartContainer}>
                <img src={"images/illustration-empty-cart.svg"} alt="empty cart" loading='lazy' />
                <p className={styles.emptyCartQuote}> Your added items will appear here</p>
            </div>
        ) : (
            <div>
                ...
                <div className={styles.message}>
                    ...
                    />
                    <p>
                        This is a <span className={styles.boldText}>carbon-neutral</span> delivery
                    </p>
                </div>
